...
const ProductList: React.FC<ProductProps> = ({ register, fields, append, remove, update, watch, setValue, flex }) => {
    ...
    return (
        <div className="w-full">
            ...
            {fields.map((product, index) => {
                ...
                return (
                    <div key={product.id} className={`flex ${flex} gap-2 items-center mb-2`}>
                        <Input
                            type="text"
